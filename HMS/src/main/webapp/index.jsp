			...
			<div class="row row-eq-height">
				...
				<div class="col-lg-4 info_box_col">
					<div class="info_form_container">
						...
						<form action="login.jsp" class="info_form" id="info_form" method="post">
							<input type="text" class="info_input" placeholder="category" required="required" name="categ">
							
							<input type="text" class="info_input" placeholder="Username" required="required" name="uname">
							<input type="password" class="info_input" placeholder="Password" name="pswd">
							<button class="info_form_button">Submit</button>
						</form>
					</div>
				</div>
			</div>
