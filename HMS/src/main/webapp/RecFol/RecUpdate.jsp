            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="contact-form">
                		...
                		int i=st.executeUpdate("update DocReg set name='" + wname + "',age='" +wage + "',department='" +wdept+ "',dob='" +wdob + "',phone='"+wphone+"',password='"+ wpass +"' ,email='"+ wmail +"' where did='"+ wid +"' ");
                	       
                    	if(i>0)
                    	{
                    		response.sendRedirect("RecProfile.jsp");
