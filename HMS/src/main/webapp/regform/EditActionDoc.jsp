            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="contact-form">
                		...
                		int i=st.executeUpdate("update patientreg set name='" + wname + "',age='" +wage + "',department='" +wdept+ "',dob='" +wdob + "',phone='"+wphone+"',date='" +wdate+ "',medicine='"+ wmedi +"' where id='"+ wid +"' ");
                	       
                    	if(i>0)
                    	{
                    		response.sendRedirect("../DocFol/PatHis.jsp");
