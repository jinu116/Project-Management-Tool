            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="contact-form">
                		...
                		int i=st.executeUpdate("insert into DocReg (name,age,dob,gender,Qualification,email,phone,department,username,password,category) values ('"+ wname +"','"+ wage +"', '"+ wdob +"','"+ wgen +"', '"+ wqual +"' , '"+ wmail +"' ,'"+ wphone +"','"+ wdept +"','"+ wuser +"','"+ wpass +"','"+ wcat +"')");
